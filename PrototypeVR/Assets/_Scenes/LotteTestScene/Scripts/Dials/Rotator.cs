...
namespace LevelUP.Dial
{
    public class Rotator : MonoBehaviour
    {
        ...
        [SerializeField] private List<Rotator> dialsGoingWith;
        ...
        public void RotateDialClockwise()
        {
            RotateClockwise();

            for (int i = 0; i < dialsGoingWith.Count; i++)
            {
                dialsGoingWith[i].RotateClockwise();

                //if (TryGetComponent<IDial>(out IDial dial2))
                //    dial2.DialChanged(dialsGoingWith[i].localEulerAngles.x);
        ...
        public void RotateDialAntiClockwise()
        {
            RotateAntiClockwise();            

            for (int i = 0; i < dialsGoingWith.Count; i++)
            {
                dialsGoingWith[i].RotateAntiClockwise();
